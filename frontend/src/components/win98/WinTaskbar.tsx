...
export const WinTaskbar: React.FC<WinTaskbarProps> = ({
  ...
  return (
    <>
      ...
      {isStartOpen && (
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <button
              className="win-btn"
              onClick={() => { onOpenSettings(); setIsStartOpen(false); }}
              style={{ justifyContent: 'flex-start', padding: '6px 10px', color: '#000080', fontWeight: 'bold' }}
            >
              <Sliders size={16} /> System Control Panel
            </button>
          </div>
        </div>
      )}
      ...
      >
        {/* Left: Start Button & Active Window Task Tabs */}
        ...
        {/* Right: Enlarged System Tray & Clock */}
        <div
          className="win-inset"
          style={{
            display: 'flex',
